...
export class AppDataService {
  ...
  countries: Array<Country> = [
    ...
    { id: 2, name: 'Luxembourg', epiIndex: 83.27 },
  ...
  createCountry(vm: Country): Observable<any> {
    //return Observable.of({}).flatMap(x => Observable.throw('Create Error'));
  ...
  deleteCountry(id: number): Observable<any> {
    ...
    //return Observable.of({}).flatMap(x => Observable.throw('Delete Error'));
